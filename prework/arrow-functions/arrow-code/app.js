...
// It referrs to the input to the student function.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The Window document property.
// 3. Explain why "this" is different when an arrow function is used.
// the contextual 'this' is ignored in arrow functions and bumps up a level in scope, to the page's window property. 
