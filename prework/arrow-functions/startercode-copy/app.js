...
// Arrow function error: student is not a constructor
...
//Arrow function only returns Hi, my name is.
// Student.prototype.greeting = function() {
//   return `Hi, my name is ${this.name}`;
// };
...
// STEP 11
// How do arrow functions affect constructor functions? Arrow functions cannot be used when creating prototypes.
...
// It is scoped to the DOM
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions does not work with .this because .this is scoped to the ///// regular function while arrow functions are scoped to the block.
