...
function displayPics(){
  ...
  // The code broke because `var` are reserved for use with functions and `let` is reserved for use in block codes. Lines 31 - 37 is a function. `let` is not accessable inside the function but can be accessed outside of it. Therefore, upon deleting the `let` line, rando becomes undefined and function no longer works.
  console.log(viewed);
